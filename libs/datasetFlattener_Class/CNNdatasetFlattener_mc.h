...
// Wed Mar 20 11:51:39 2024 by ROOT version 6.24/08
// from TTree T/skimmed T
// found on file: ../../../data/signal.root
//////////////////////////////////////////////////////////

#ifndef CNNdatasetFlattener_mc_h
#define CNNdatasetFlattener_mc_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   CNNdatasetFlattener_mc(TTree *tree=0);
   virtual ~CNNdatasetFlattener_mc();
...
#ifdef CNNdatasetFlattener_mc_cxx
CNNdatasetFlattener_mc::CNNdatasetFlattener_mc(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../data/signal.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../data/signal.root");
      }
      f->GetObject("T",tree);
...
CNNdatasetFlattener_mc::~CNNdatasetFlattener_mc()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CNNdatasetFlattener_mc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CNNdatasetFlattener_mc::LoadTree(Long64_t entry)
{
...
void CNNdatasetFlattener_mc::Init(TTree *tree)
{
...
Bool_t CNNdatasetFlattener_mc::Notify()
{
...
void CNNdatasetFlattener_mc::Show(Long64_t entry)
{
...
Int_t CNNdatasetFlattener_mc::Cut(Long64_t entry)
{
...
#endif // #ifdef CNNdatasetFlattener_mc_cxx
